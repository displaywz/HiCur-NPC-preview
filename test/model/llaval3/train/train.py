...
from model.llaval3.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from torch.utils.data import Dataset
from model.llaval3.train.llava_trainer import LLaVATrainer

from model.llaval3 import conversation as conversation_lib
from model.llaval3.model import *
from model.llaval3.mm_utils import tokenizer_image_token
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            # if '.' in image_file:
            #     images = os.listdir(os.path.join(image_folder, image_file))
            # image = os.path.join(os.path.join(image_folder, image_file),image)
            ...
            # self.data_args.image_aspect_ratio == 'mae'
